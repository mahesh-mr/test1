...
class ImageService {
  ...
  static Future<String?> imageUpolodService(
   ...
   // String sinaturePath,
      ...
      final imageuplod=Get.put(ImageUplodController());  String? survayId = GetLocalStorage.getfpsId('sId');
    try {
   ...
   imageuplod.siganatureImagePath==null? "":     signatureFilePath = await MultipartFile.fromFile(
          imageuplod.siganatureImagePath!,
          filename:   imageuplod.siganatureImagePath,
 ...
 print("$survayId === ");
  ...
  static Future<String?> imageUpolodService2(
    String shopimagePath,
  ) async { String? survayId = GetLocalStorage.getfpsId('sId');
    try {
      MultipartFile placeFilePath = await MultipartFile.fromFile(shopimagePath,
          filename: shopimagePath, contentType: MediaType('image', 'jpg'));
